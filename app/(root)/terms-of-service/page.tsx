        ...
        <section className="bg-gray-100 w-full py-5 md:py-20">
            <div className="container flex flex-col gap-6">
                ...
                <ul className="flex flex-col gap-4">
                    ...
                    <ul className="flex flex-col gap-4">
                        <li>• Вам предоставляется право использовать наш сайт в личных, некоммерческих целях(в ином случае всё должно быть согласованно с Раяповым Нурсултаном).</li>
                        ...
                        <li>• Вы имеете право посетить нашу {" "}
                            <a href="https://game.physics-hub.com/" target="_blank" rel="noopener noreferrer">
                        пасхалку(симулятор физики мяча)
                        </a>. </li>
                    </ul>
