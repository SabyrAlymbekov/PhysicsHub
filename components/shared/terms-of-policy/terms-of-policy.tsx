    ...
    return (
        <section className="bg-gray-100 mt-[66px] w-full py-5 md:py-20">
            <div className="container flex flex-col gap-6">
                ...
                <p>Добро пожаловать на [Название сайта]! Пожалуйста, внимательно прочитайте эти Условия использования,
                ...
                <ul className="flex flex-col gap-4">
                    ...
                    <ul className="flex flex-col gap-4">
                        <li>• Используя сайт [Название сайта] (далее – “Сайт”), вы подтверждаете, что прочитали, поняли
                    ...
                    <p>Использование нашего сайта регулируется также нашей Политикой конфиденциальности, которая
                        ...
                        с Политикой конфиденциальности на [ссылка на Privacy Policy].</p>

                    <li>5. Интеллектуальная собственность</li>
                    <ul className="flex flex-col gap-4">
                        <li>• Весь контент, размещенный на сайте, включая тексты, изображения, логотипы, графику,
                            является собственностью [Название компании] и защищен законами об авторском праве.
                        </li>
                    ...
                    <p>Настоящие Условия регулируются и толкуются в соответствии с законодательством [вашей страны или
                        штата]. Любые споры, возникающие в связи с использованием сайта, подлежат разрешению в судах
                        [вашей страны или штата].</p>

                    <li>10. Контакты</li>
                    <p>Если у вас есть вопросы по поводу этих Условий использования, пожалуйста, свяжитесь с нами по
                        адресу: [контактный адрес электронной почты].</p>
                </ul>
            </div>
        </section>
